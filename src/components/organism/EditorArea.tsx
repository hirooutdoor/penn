        ...
        <div className='my-3 border-b dark:border-b-penn-gray'>
          <div className="mt-6 ml-8 ">
            ...
            <ul className='flex cursor-pointer mt-4 border-b dark:border-b-penn-gray'>
              <li className='ml-4 py-2 px-6 bg-white rounded-t-lg border-b hover:border dark:bg-penn-darkGray hover:border-b-white dark:border-penn-gray  dark:border-b-penn-darkGray'>Write</li>
            ...
            <textarea className='w-[100%] h-60 border-none outline-none dark:border-penn-gray dark:bg-penn-darkGray rounded-lg p-8 text-left mb-10 '/>
          </div>
