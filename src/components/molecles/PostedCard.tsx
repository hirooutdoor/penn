...
const PostedCard = (props: Props) => {
  return (
    <>
      <div className='shadow-md group rounded-md bg-white flex justify-center items-center content-div cursor-pointer'>
        <div>
          ...
          height={100}
          layout='fixed'/>
          <div className='pb-8 pt-2 px-4 bg-white  rounded-b-md fd-cl '>
